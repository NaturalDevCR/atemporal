...
function buildMethodIndex() {
  ...
  const entries = [
    ...
    { kind: 'static', name: 'atemporal.validate(input)', sig: '() => ValidationResult', note: 'Detailed validation: { ok: boolean, iso?: string, confidence?: number, reason?: string, code?: ATEMPORAL_* }.' },
