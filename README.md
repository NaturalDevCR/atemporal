...
¹ _Requires the `advancedFormat` plugin._

_(Note: Characters in brackets `[]` are displayed literally.)_
...
const precise1 = atemporal.fromFormat(
  "2024-01-01 12:30:45.123",
  "YYYY-MM-DD HH:mm:ss.SSS"
);
const precise2 = atemporal.fromFormat(
  "2024-01-01 12:30:45.12",
  "YYYY-MM-DD HH:mm:ss.SS"
); // 120ms
const precise3 = atemporal.fromFormat(
  "2024-01-01 12:30:45.1",
...
// With timezone
const withTz = atemporal.fromFormat(
  "2024-01-01 15:30",
  "YYYY-MM-DD HH:mm",
  "America/New_York"
);
...
- **Japanese (ja)**: 1 番目, 2 番目, 3 番目, 4 番目...
- **Korean (ko)**: 1번째, 2번째, 3번째, 4번째...
- **Chinese (zh)**: 第 1, 第 2, 第 3, 第 4... (prefix format)
...
const touchingResult = atemporal.checkDateRangeOverlap(
  touching1,
  touching2,
  options
);
